...
{{% notice note %}}
Kubermatic machine-controller works only on [natively-supported providers]({{< pref "/introduction/supported-providers/" >}}), so we can't use it for bare metal setups. Instead, we'll create worker nodes manually and use the KubeOne Static Worker Nodes feature to provision those worker nodes.
{{% /notice %}}
...
[compatibility-providers]: {{< pref "/introduction/supported-providers" >}}
[static-workers]: {{< pref "/guides/static-workers" >}}
[creating-clusters]: {{< pref "/get-started/create-cluster" >}}
...
[machine-controller]: {{< pref "/guides/machine-controller" >}}
[getting-kubeone]: {{< pref "/get-started/get-kubeone" >}}
[cluster-reconciliation]: {{< pref "/introduction/cluster-reconciliation" >}}
[access-clusters]: https://kubernetes.io/docs/tasks/access-application-cluster/configure-access-multiple-clusters/
[upgrading-clusters]: {{< pref "/get-started/upgrade-cluster" >}}
[unprovisioning-clusters]: {{< pref "/get-started/unprovision-cluster" >}}
[production-recommendations]: {{< pref "/cheat-sheets/production-recommendations" >}}
[create-cluster-oidc]: {{< pref "/uncategorized/creating-clusters-oidc" >}}
[configuring-ssh]: {{< pref "/guides/ssh" >}}
[ha-load-balancing]: {{< pref "/examples/ha-load-balancing" >}}
[supported-os]: {{< pref "/introduction/compatibility/os-support-matrix/" >}}
