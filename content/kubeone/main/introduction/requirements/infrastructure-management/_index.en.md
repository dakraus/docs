...
[ssh]: {{< pref "/guides/ssh#sshd-requirements-on-instances" >}}
...
[concepts]: {{< pref "/introduction/concepts#kubermatic-machine-controller" >}}
[concepts-mc]: {{< pref "/introduction/concepts#kubermatic-machine-controller" >}}
[ha-lb-example]: {{< pref "/examples/ha-load-balancing" >}}
[terraform-reference]: {{< pref "/references/terraform-integration" >}}
[production-recommendations]: {{< pref "/cheat-sheets/production-recommendations" >}}
