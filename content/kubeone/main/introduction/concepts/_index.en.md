...
[production_recommendations]: {{< pref "/cheat-sheets/production-recommendations" >}}
{{% /notice %}}
...
[using-machine-controller]: {{< pref "/guides/machine-controller" >}}
[cluster-api]: https://github.com/kubernetes-sigs/cluster-api
[cluster-api-book]: https://cluster-api.sigs.k8s.io/
[cluster-provisioning]: {{< pref "#cluster-provisioning-and-management" >}}
