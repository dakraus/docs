...
[concepts]: {{< pref "/introduction/concepts/" >}}
[machine-controller]: {{< pref "/guides/machine-controller/" >}}
[addons]: {{< pref "/guides/addons/" >}}
[cluster-creation]: {{< pref "/tutorials/creating-clusters/" >}}
[step-5]: {{< pref "/tutorials/creating-clusters/#step-5" >}}
[embedded-addons]: {{< pref "/guides/addons/#overriding-embedded-eddons" >}}
