...
[Overwriting Image Registries guide]({{< pref "/guides/registry-configuration" >}})
...
[containerreg-api]: {{< pref "/references/kubeone-cluster-v1beta2#containerruntimecontainerd" >}}
[containerruntime-docker]: {{< pref "/references/kubeone-cluster-v1beta2#containerruntimedocker" >}}
