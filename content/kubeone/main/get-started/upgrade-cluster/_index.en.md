...
[manifest]: {{< pref "/introduction/concepts/#kubeone-configuration-manifest" >}}
[tf-json]: {{< pref "/introduction/requirements/infrastructure-management/#terraform-integration" >}}
