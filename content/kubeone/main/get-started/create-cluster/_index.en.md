...
[vSphere requirements document]({{< pref "/introduction/requirements/machine-controller/vsphere/vsphere/" >}})
for more details.
...
Please check the [Production Recommendations]({{< pref "/cheat-sheets/production-recommendations" >}})
...
[terraform-configs]: {{< pref "/guides/using-terraform-configs" >}}
...
[azure-sa-setup]: {{< pref "/introduction/requirements/machine-controller/azure" >}}
