...
To do so via  cli, simply follow the guide in the machine-controller [documentation]({{< pref product="kubeone" version="v1.5" path="cheat-sheets/rollout-machinedeployment" >}}).
