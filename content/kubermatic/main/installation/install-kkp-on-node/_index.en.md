...
> For more information on the kubeone configurations for different environment, checkout the [Creating the kubernetes Cluster using Kubeone]({{< pref product="kubeone" version="main" path="get-started/create-cluster" >}}) documentation.
