...
See there related [KubeOne documentation]({{< pref product="kubeone" version="v1.5" path="guides/credentials/#environment-variables" >}}), select OpenStack tab.
{{% /tab %}}
{{% tab name="vSphere" %}}
...
pay attention to the vSphere specific [permissions]({< pref product="kubeone" version="v1.5" path="architecture/requirements/machine-controller/vsphere" >}}).
{{% /tab %}}
{{% /tabs %}}
